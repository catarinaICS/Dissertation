...
\item Testability - how easy it is to check system fauls through testing;
...
\end{class}
\begin{class}[text width=2cm ]{Relation}{-1,-12.5}
\end{class}

\begin{class}[text width=2cm ]{Element}{6,-12.5}
\inherit{Concept}
\end{class}

\begin{class}[text width=1.5cm]{Is Part Of}{-4,-14.5}
\inherit{Relation}
\end{class}

\draw [umlcd style] (-2.5,-14.90) node {[...]};

\begin{class}[text width=2cm]{Connector}{-1,-14.5}
\inherit{Relation}
\end{class}

\begin{class}[text width=2cm]{Allocated To}{1.5,-14.5}
\inherit{Relation}
\end{class}

\begin{class}[text width=2cm]{Module}{4,-14.5}
\inherit{Element}
\end{class}

\begin{class}[text width=2cm]{Component}{6.5,-14.5}
\inherit{Element}
\end{class}

\begin{class}[text width=2.5cm]{Environmental Element}{9.5,-14.5}
\inherit{Element}
\end{class}
...
The Scenario, View and the Element are considered the main concepts of the domain, and they all have a dedicated template, as it will be described in the next section. These templates will contain the relationships between these main concepts and the other concepts in the domain model.
